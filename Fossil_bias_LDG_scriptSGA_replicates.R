...
Mam_75bs <- Mam_75rs[,c("X", "Y",Combi_75bs$iucn2020_binomial, "Land_mass", 
                        "Clim_zone", "GUM_USC", "WC_zone", "Richness", "Land", 
                        "Area", "Fossils", "Richness2")]#2649  
...
Mam_50bs <- Mam_50rs[,c("X", "Y",Combi_50bs$iucn2020_binomial, "Land_mass", 
                        "Clim_zone", "GUM_USC", "WC_zone", "Richness", "Land", 
                        "Area", "Fossils", "Richness2")]#1186 
...
Mam_25bs <- Mam_25rs[,c("X", "Y",Combi_25bs$iucn2020_binomial, "Land_mass", 
                        "Clim_zone", "GUM_USC", "WC_zone", "Richness", "Land", 
                        "Area", "Fossils", "Richness2")]#308 
...
length(which(colSums(Mam_75fos[,3:2639]) == 0)) # 597 spp lost, 2637-597 = 2040 spp
Mam_75fos_df <- Mam_75fos[,c("X", "Y", "Richness3")]
Mam_75fos_rast <- rasterize(x = as.matrix(Mam_75fos_df[,1:2]), 
                            y = as(x, "SpatRaster"), 
...
length(which(colSums(Mam_50fos[,3:1176]) == 0)) # 171 spp lost, 1174-171 = 1003 spp
Mam_50fos_df <- Mam_50fos[,c("X", "Y", "Richness3")]
Mam_50fos_rast <- rasterize(x = as.matrix(Mam_50fos_df[,1:2]), 
                            y = as(x, "SpatRaster"), 
...
length(which(colSums(Mam_25fos[,3:298]) == 0)) #22 app lost, 296-22 = 274 spp
Mam_25fos_df <- Mam_25fos[,c("X", "Y", "Richness3")]
Mam_25fos_rast <- rasterize(x = as.matrix(Mam_25fos_df[,1:2]), 
                            y = as(x, "SpatRaster"), 
...
#2 families in Combi_75bs are not in Mam_pbdb (Nandiniidae, Prionodontidae)
sort(table(Combi_6[Combi_6$family %in% spp_Combir, "family"])) #3 spp
spp_Mampbdb <- sort(setdiff(unique(Mam_pbdb$family), unique(Combi_6$family)))
#488 families in Mam_pbdb are not in Combi_r

Combi_6 <- Combi_6[!Combi_6$family %in% spp_Combir,] # 119 families, 3 spp lost
Mam_pbdb3 <- Mam_pbdb[!Mam_pbdb$family %in% spp_Mampbdb,] #119 families
...
Mam_75tax <- Mam_75fos[,c("X", "Y",Combi_75tax$iucn2020_binomial, "Land_mass", 
                          "Clim_zone", "GUM_USC", "WC_zone", "Richness", "Land", 
                          "Area", "Fossils", "Richness2","Richness3")] #1540
...
Mam_75tax2 <- Mam_75fos[,c("X", "Y",Combi_7$iucn2020_binomial, "Land_mass", 
                           "Clim_zone", "GUM_USC", "WC_zone", "Richness", "Land", 
...
sort(table(Combi_50fos[Combi_50fos$family %in% spp_Combi50fos, "family"])) #3 spp
spp_Mampbdb <- sort(setdiff(unique(Mam_pbdb$family), unique(Combi_50fos$family)))
#503 families in Mam_pbdb are not in Combi_r

Combi_50fos <- Combi_50fos[!Combi_50fos$family %in% spp_Combi50fos,] #1000 obs, 104 families, 2 spp lost
Mam_pbdb50fos <- Mam_pbdb[!Mam_pbdb$family %in% spp_Mampbdb,] #104 families
...
#1 family in Combi_25fos are not in Mam_pbdb
sort(table(Combi_25fos[Combi_25fos$family %in% spp_Combi25fos, "family"])) #2 spp
spp_Mampbdb <- sort(setdiff(unique(Mam_pbdb$family), unique(Combi_25fos$family)))
#546 families in Mam_pbdb are not in Combi_r

Combi_25fos <- Combi_25fos[!Combi_25fos$family %in% spp_Combi25fos,] #272 obs, 61 families, 1 spp lost
Mam_pbdb25fos <- Mam_pbdb[!Mam_pbdb$family %in% spp_Mampbdb,] #61 families
...
Mam_25tax2 <- Mam_25fos[,c("X", "Y",Combi_25fos2$iucn2020_binomial, "Land_mass", 
                           "Clim_zone", "GUM_USC", "WC_zone", "Richness", "Land", 
                           "Area", "Fossils", "Richness2","Richness3")] 
...
################################################################################
######## Repeat for seed = 1795 960, 1893, 1610, 717, 774, 944, and 1942 #######
################################################################################
